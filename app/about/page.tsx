  ...
  return (
    <>
        ...
        <div className="flex flex-col mx-auto px-4 items-center justify-center">
          <div className="flex mt-[100px]  max-w-[740px]  flex-col items-center justify-center gap-8">
            ...
            <p className="text-[16px] text-center">
              We embody community based learning - boosting motivation , and
              fostering growth.{" "}
            </p>
            <div className="hidden gap-4">
              <Link
                className="w-[124px] border rounded-xl border-white bg-white text-[#0266AD]  font-medium text-base text-center py-2"
                href={"/"}
              >
                Explore
              </Link>
              <Link
                className="w-[124px] border rounded-xl border-white bg-transparent text-white  font-medium text-base text-center  py-2"
                href={"/"}
              >
                Learn More
              </Link>
      ...
      <section className="flex flex-col items-center md:gap-2 px-4">
        <h2 className="font-poppins text-[#272D37] font-bold text-4xl md:text-4xl text-center">
          Our Core Values
        </h2>
        <Link
          href="#"
      ...
      <section className="mt-4 mb-8 md:mb-48 flex flex-col items-center px-6">
        <h2
          className={`mb-2 font-poppins text-[#272D37] font-bold text-3xl md:text-4xl text-center`}
        >
